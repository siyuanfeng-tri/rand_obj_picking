...
using sensor_bridge::RealSenseSR300;
...
void CloudThread(robot_bridge::RobotBridge* robot_comm,
                 const sensor_bridge::RealSenseSR300* camera_interface,
...
int main(int argc, char** argv) {
  ...
  */
  ...
  /*
  camera_interface.set_focal_length_x(sensor_bridge::ImageType::DEPTH, 481.634496904251);
  camera_interface.set_focal_length_y(sensor_bridge::ImageType::DEPTH, 482.5884407032157);
  camera_interface.set_principal_point_x(sensor_bridge::ImageType::DEPTH, 321.0790258817788);
  camera_interface.set_principal_point_y(sensor_bridge::ImageType::DEPTH, 245.2850786716308);
  camera_interface.set_focal_length_x(sensor_bridge::ImageType::IR, 481.634496904251);
  camera_interface.set_focal_length_y(sensor_bridge::ImageType::IR, 482.5884407032157);
  camera_interface.set_principal_point_x(sensor_bridge::ImageType::IR, 321.0790258817788);
  camera_interface.set_principal_point_y(sensor_bridge::ImageType::IR, 245.2850786716308);

  camera_interface.set_focal_length_x(sensor_bridge::ImageType::RGB, 618.8411523746104);
  camera_interface.set_focal_length_y(sensor_bridge::ImageType::RGB, 620.3575322440417);
  camera_interface.set_principal_point_x(sensor_bridge::ImageType::RGB, 312.7944888695696);
  camera_interface.set_principal_point_y(sensor_bridge::ImageType::RGB, 235.5000184550021);
  camera_interface.set_focal_length_x(sensor_bridge::ImageType::RECT_RGB, 618.8411523746104);
  camera_interface.set_focal_length_y(sensor_bridge::ImageType::RECT_RGB, 620.3575322440417);
  camera_interface.set_principal_point_x(sensor_bridge::ImageType::RECT_RGB, 312.7944888695696);
  camera_interface.set_principal_point_y(sensor_bridge::ImageType::RECT_RGB, 235.5000184550021);
  camera_interface.set_focal_length_x(sensor_bridge::ImageType::RECT_RGB_ALIGNED_DEPTH, 618.8411523746104);
  camera_interface.set_focal_length_y(sensor_bridge::ImageType::RECT_RGB_ALIGNED_DEPTH, 620.3575322440417);
  camera_interface.set_principal_point_x(sensor_bridge::ImageType::RECT_RGB_ALIGNED_DEPTH, 312.7944888695696);
  camera_interface.set_principal_point_y(sensor_bridge::ImageType::RECT_RGB_ALIGNED_DEPTH, 235.5000184550021);
  */

  //const sensor_bridge::ImageType depth_type = sensor_bridge::ImageType::DEPTH;
  //const sensor_bridge::ImageType color_type = sensor_bridge::ImageType::DEPTH_ALIGNED_RGB;
  const sensor_bridge::ImageType depth_type = sensor_bridge::ImageType::RECT_RGB_ALIGNED_DEPTH;
  const sensor_bridge::ImageType color_type = sensor_bridge::ImageType::RECT_RGB;
  const std::vector<sensor_bridge::ImageType> channels = {color_type, depth_type};
  camera_interface.Start({color_type, depth_type, sensor_bridge::ImageType::DEPTH}, color_type);
